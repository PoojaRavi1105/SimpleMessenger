...
public class SimpleMessengerActivity extends Activity {
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
             ...
             * to onProgressUpdate().
             */
            /* To understand reading from and writing to a socket in Java:
            ...
            try {
                while(true) {
                    ...
                    /* If the server successfully binds to its port,
                       then the ServerSocket object is successfully created and the server continues to
                       the next step—accepting a connection from a client */
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                /* Prints the message to PrintWriter. */
                w.println(msgToSend);
